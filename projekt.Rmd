...
```{r starost_nemcija, echo=FALSE, fig.align='center', fig.cap='Starost avtomonilov v Nemčiji'}
...
```{r teza_francija, echo=FALSE, fig.align='center', fig.cap='Teža avtomobilov v Franciji'}
print(teza_francija)
```
...
```{r goriva_sever, echo=FALSE, fig.align='center', fig.cap='Vrste goriv na severu Evrope'}
print(goriva_sever)
```
